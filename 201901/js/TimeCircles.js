...
(function($) {
    ...
    TC_Instance.prototype.initialize = function(clear_listeners) {
        ...
        this.data.attributes.radius = ((this.data.attributes.item_size * 0.62) - this.data.attributes.line_width) / 2;
        ...
        for (var key in this.data.text_elements) {
            ...
            var textElement = $("<div>");
            textElement.addClass('circle-content textDiv_' + key);
            ...
            numberElement.addClass("time-span-number");

            var headerElement = $("<h4>");
            headerElement.text(this.config.time[key].text); // Options
            headerElement.css("font-size", Math.round(this.config.text_size * this.data.attributes.item_size));
            headerElement.appendTo(textElement);
            headerElement.addClass('time-span-word');
